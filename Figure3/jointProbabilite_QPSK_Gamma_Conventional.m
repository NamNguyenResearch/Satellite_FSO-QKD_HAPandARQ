function jointProbabiliteGamma=jointProbabilite_QPSK_Gamma_Conventional(bit_Alice,bit_Bob,Attenuation,ScaleCo,P_T_dBm,C2n) 
    ...
    G_Tx=10^(G_Tx_dB/10);
    G_Rx_dB=135;                   %Rx telescope gain(dB)
    G_Rx=10^(G_Rx_dB/10);

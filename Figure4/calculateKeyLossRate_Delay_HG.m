function [delayOutageRate]=calculateKeyLossRate_Delay_HG(M,B,QBER_SH,P_sift_SH,QBER_HG,P_sift_HG,lamda) 
    ...
    KER_SH=1-(1-QBER_SH)^(l_k*P_sift_SH);
    KER_HG=1-(1-QBER_HG)^(l_k*P_sift_SH*P_sift_HG);
    
    p_bb=(1-KER_SH)*KER_HG*(1-t_k/t_0);
    p_bg=1-p_bb;
    p_gg=(1-KER_SH)*(1-KER_HG)*(1-t_k/t_0);
    p_gb=1-p_gg;
    
    %Note
    lamda=(1-KER_SH)*lamda;
